...
def is_valid_password_sled_rental(password, char, min_, max_):
    if min_ <= password.count(char) <= max_:
        return 1
    return 0


def is_valid_password_toboggan_rental(password, char, position_1, position_2):
...
def main():
    ...
    with open('inputs/day_02.txt') as input_file:
        for input_ in input_file:
            ...
            valid_passwords_toboggan_rental += is_valid_password_toboggan_rental(*parsed_inputs)

    print(valid_passwords_sled_rental)
    print(valid_passwords_toboggan_rental)
